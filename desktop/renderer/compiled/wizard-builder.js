...
function CatalogPreviewChat({ w, onClose, onInstall }) {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { style: wbS.overlay }, /*#__PURE__*/
    React.createElement("div", { onClick: onClose, style: wbS.scrim }), /*#__PURE__*/
    React.createElement("div", { style: { ...wbS.panel, width: 'var(--ask-width, 380px)' } }, /*#__PURE__*/
    React.createElement("div", { style: wbS.head }, /*#__PURE__*/
    React.createElement("span", { style: wbS.headIcon }, /*#__PURE__*/React.createElement(WbIcon, { name: "message-circle", size: 14, style: { color: 'var(--brand-fg)' } })), /*#__PURE__*/
    React.createElement("span", { style: wbS.title }, "Preview \xB7 ", w.name),
    onInstall && /*#__PURE__*/React.createElement(WbButton, { variant: "secondary", size: "sm", icon: "download", onClick: onInstall }, "Install"), /*#__PURE__*/
    React.createElement("button", { onClick: onClose, "aria-label": "Close preview chat", style: wbS.close }, /*#__PURE__*/React.createElement(WbIcon, { name: "x", size: 16 }))
    ), /*#__PURE__*/
    React.createElement("div", { ref: scrollRef, style: wbS.scroll },
    messages.length === 0 && /*#__PURE__*/
    React.createElement("div", { style: { padding: '24px 6px', textAlign: 'center' } }, /*#__PURE__*/
    React.createElement("p", { style: { fontFamily: 'var(--font-serif)', fontSize: 16, color: 'var(--text-body)', margin: '0 0 4px' } }, "Preview ", w.name, "."), /*#__PURE__*/
    React.createElement("p", { style: { fontSize: 12.5, color: 'var(--text-subtle)', margin: 0, lineHeight: 1.5 } }, "Not installed yet \u2014 answers come from the catalog listing only. Install to chat over the full contents."
    ...
    React.createElement(WbAskMessage, { key: i, role: "user" }, m.text) : /*#__PURE__*/
    React.createElement(WbAskMessage, { key: i, role: "answer" }, /*#__PURE__*/React.createElement("span", { style: { whiteSpace: 'pre-wrap' } }, m.text))
    )
    ), /*#__PURE__*/
    React.createElement("div", { style: wbS.foot }, /*#__PURE__*/
    React.createElement("div", { style: wbS.inputBox }, /*#__PURE__*/
    React.createElement("textarea", { value: draft, onChange: (e) => setDraft(e.target.value), rows: 2,
      onKeyDown: (e) => {if (e.key === 'Enter' && !e.shiftKey) {e.preventDefault();send();}},
      "aria-label": `Preview ${w.name}`, placeholder: `Ask what ${w.name} covers…`, style: wbS.textarea }), /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', justifyContent: 'flex-end', marginTop: 6 } }, /*#__PURE__*/
    React.createElement("button", { onClick: send, disabled: !draft.trim(), "aria-label": "Send question", style: wbS.sendBtn(!draft.trim()) }, /*#__PURE__*/
    React.createElement(WbIcon, { name: "arrow-up", size: 15 })
    )
    )
    )
    )
...
function WizardBuilder({ scopes, onClose, onCreated }) {
  ...
  const create = async () => {
    ...
    if (r && r.ok) onCreated(r.wizard);else
    setError(r && r.error || 'Could not create the wizard.');
    setCreating(false);
  };
  ...
  return (/*#__PURE__*/
    React.createElement("div", { style: wbS.overlay }, /*#__PURE__*/
    React.createElement("div", { onClick: onClose, style: wbS.scrim }), /*#__PURE__*/
    React.createElement("div", { style: { ...wbS.panel, width: 460 } }, /*#__PURE__*/
    React.createElement("div", { style: wbS.head }, /*#__PURE__*/
    React.createElement("span", { style: wbS.headIcon }, /*#__PURE__*/React.createElement(WbIcon, { name: "wand-2", size: 14, style: { color: 'var(--brand-fg)' } })), /*#__PURE__*/
    React.createElement("span", { style: wbS.title }, "Create a wizard"), /*#__PURE__*/
    React.createElement("button", { onClick: onClose, "aria-label": "Close wizard builder", style: wbS.close }, /*#__PURE__*/React.createElement(WbIcon, { name: "x", size: 16 }))
    ), /*#__PURE__*/

    React.createElement("div", { ref: scrollRef, style: wbS.scroll },
    messages.length === 0 && /*#__PURE__*/
    React.createElement("div", { style: { padding: '24px 6px', textAlign: 'center' } }, /*#__PURE__*/
    React.createElement("p", { style: { fontFamily: 'var(--font-serif)', fontSize: 16, color: 'var(--text-body)', margin: '0 0 4px' } }, "Describe the knowledge base you want."), /*#__PURE__*/
    React.createElement("p", { style: { fontSize: 12.5, color: 'var(--text-subtle)', margin: 0, lineHeight: 1.5 } }, "e.g. \u201Ceverything about my trading bots\u201D \u2014 Lore searches your notes, you confirm the list, and the wizard is ready to chat. Notes stay where they are."
    ...
    searching && /*#__PURE__*/React.createElement("div", { style: { fontFamily: 'var(--font-mono)', fontSize: 11.5, color: 'var(--text-faint)', padding: '4px 0 4px 36px' } }, "searching\u2026"),

    cands.length > 0 && /*#__PURE__*/
    React.createElement("div", { style: { margin: '10px 0 4px', border: '1px solid var(--border)', borderRadius: 'var(--radius-md)', background: 'var(--surface-inset)', overflow: 'hidden' } }, /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', borderBottom: '1px solid var(--divider)' } }, /*#__PURE__*/
    React.createElement("span", { style: { flex: 1, fontSize: 12.5, fontWeight: 600, color: 'var(--text-strong)' } }, "Matched notes"), /*#__PURE__*/
    React.createElement(WbBadge, { tone: "info" }, pickedIds.length, " of ", cands.length, " selected")
    ), /*#__PURE__*/
    React.createElement("div", { style: { maxHeight: 220, overflowY: 'auto', padding: '6px 12px 8px' } },
    cands.map((c) => /*#__PURE__*/
    React.createElement("div", { key: c.id, style: { display: 'flex', alignItems: 'center', gap: 8, padding: '3px 0' } }, /*#__PURE__*/
    React.createElement(WbCheckbox, { checked: c.checked, onChange: () => toggle(c.id), label: c.title || c.id, style: { fontSize: 12.5, minWidth: 0 } })
    )
    )
    )
    )
    ...
    React.createElement("div", { style: wbS.foot },
    cands.length > 0 && /*#__PURE__*/
    React.createElement("div", { style: { marginBottom: 10 } }, /*#__PURE__*/
    React.createElement("input", { value: name, onChange: (e) => {setName(e.target.value);setNameTouched(true);}, placeholder: "Wizard name\u2026", "aria-label": "Wizard name",
      style: { width: '100%', boxSizing: 'border-box', padding: '7px 10px', border: '1px solid var(--border-field)', borderRadius: 'var(--radius-sm)', background: 'var(--surface-inset)', color: 'var(--text-strong)', fontFamily: 'var(--font-sans)', fontSize: 13, outline: 'none' } }), /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 6, marginTop: 8, flexWrap: 'wrap' } },
    WB_SCOPES.map((s) => /*#__PURE__*/
    React.createElement("button", { key: s.id, onClick: () => setShareScope(s.id), style: chip(shareScope === s.id) }, s.label)
    ), /*#__PURE__*/
    React.createElement("div", { style: { flex: 1 } }), /*#__PURE__*/
    React.createElement(WbButton, { variant: "primary", size: "sm", icon: creating ? 'loader' : 'wand-2', onClick: create, disabled: creating || !name.trim() || !pickedIds.length },
    creating ? 'Creating…' : `Create wizard (${pickedIds.length})`
    )
    ), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: 11, color: 'var(--text-faint)', marginTop: 5 } }, scopeHint),
    error && /*#__PURE__*/React.createElement("div", { style: { fontSize: 11.5, color: 'var(--clay-400)', marginTop: 5 } }, error)
    ), /*#__PURE__*/
    ...
    React.createElement("textarea", { value: draft, onChange: (e) => setDraft(e.target.value), rows: 2,
      ...
      style: wbS.textarea }), /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', justifyContent: 'flex-end', marginTop: 6 } }, /*#__PURE__*/
    React.createElement("button", { onClick: send, disabled: searching || !draft.trim(), "aria-label": "Search notes", style: wbS.sendBtn(searching || !draft.trim()) }, /*#__PURE__*/
    React.createElement(WbIcon, { name: "arrow-up", size: 15 })
    )
    )
    )
