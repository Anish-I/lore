...
function HK_Section({ icon, title, action, children }) {
  return (/*#__PURE__*/
    React.createElement("div", { style: HK_S.section }, /*#__PURE__*/
    React.createElement("div", { style: HK_S.secHead }, /*#__PURE__*/
    React.createElement(HK_Icon, { name: icon, size: 15, style: { color: 'var(--brand-fg)' } }), /*#__PURE__*/
    React.createElement("span", { style: { flex: 1, fontSize: 13, fontWeight: 600, color: 'var(--text-strong)' } }, title),
    action
    ),
    children
    ));
...
function HK_Row({ label, hint, children, last }) {
  return (/*#__PURE__*/
    React.createElement("div", { style: { ...HK_S.row, borderBottom: last ? 'none' : HK_S.row.borderBottom } }, /*#__PURE__*/
    React.createElement("div", { style: { flex: 1 } }, /*#__PURE__*/
    React.createElement("div", { style: HK_S.label }, label),
    hint && /*#__PURE__*/React.createElement("div", { style: HK_S.hint }, hint)
    ),
    children
    ));
...
function HK_ToolRow({ id, name, description, detected, status, statusEntry, cfg, onToggle, onMode, onScope, scopeOptions, identityReady, last }) {
  ...
  return (/*#__PURE__*/
    React.createElement(HK_Row, { label: label, hint: description, last: last }, /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end' } },
    experimental && /*#__PURE__*/
    React.createElement(HK_Badge, { tone: "neutral" }, "Experimental \u2014 coming soon"),

    !experimental && !identityReady && /*#__PURE__*/
    React.createElement(HK_Badge, { tone: "neutral" }, "needs identity"), /*#__PURE__*/

    React.createElement(HK_Badge, { tone: badgeTone, dot: liveStatus === 'capturing' }, liveStatus),

    enabled && !experimental && /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement(HK_Select, {
      value: cfg.mode,
      onChange: (e) => onMode(e.target.value),
      options: ['live', 'session-end'] }
    ),
    window.LoreHelpHint && /*#__PURE__*/React.createElement(window.LoreHelpHint, { size: 13, tip: HK_SCOPE_TIP }), /*#__PURE__*/
    React.createElement(HK_Select, {
      value: cfg.scope,
    ...
    React.createElement(HK_Switch, {
      checked: enabled,
      onChange: (v) => onToggle(v),
      disabled: installing || !enabled && cannotEnable }
    ),

    (enabled || statusEntry && statusEntry.installed) && /*#__PURE__*/
    React.createElement(HK_Button, { variant: "ghost", size: "sm", onClick: () => onToggle(false) }, "Uninstall"

    )

    ),
    cfg.error && /*#__PURE__*/
    React.createElement("div", { style: { width: '100%', marginTop: 6, fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--clay-400)', paddingLeft: 0, lineHeight: 1.5 } },
    cfg.error
    ),

    cfg.detail && /*#__PURE__*/
    React.createElement("div", { style: { width: '100%', marginTop: 6, fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--jade-400)', paddingLeft: 0, lineHeight: 1.5 } },
    cfg.detail
    )
...
function HooksView({ scopeOptions = [], identityReady = false, tenant = null, scope = null, onOpenSetup }) {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { style: HK_S.wrap }, /*#__PURE__*/
    React.createElement("div", { style: HK_S.body }, /*#__PURE__*/

    React.createElement("div", { style: { display: 'flex', alignItems: 'flex-start', gap: 14, marginBottom: 24 } }, /*#__PURE__*/
    ...
    ready === null && /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 10, padding: '20px 0', fontFamily: 'var(--font-mono)', fontSize: 12, color: 'var(--text-faint)' } }, /*#__PURE__*/
    React.createElement(HK_Icon, { name: "loader", size: 14, style: { color: 'var(--brand-fg)' } }), "Detecting tools\u2026"
    ...
    allToolIds.filter((id) => id !== 'generic').map((id, i, arr) => {
      ...
      return (/*#__PURE__*/
        React.createElement(HK_ToolRow, {
          key: id,
          id: id,
          name: tool.name,
    ...
    React.createElement(HK_Section, { icon: "terminal", title: "Any other tool" }, /*#__PURE__*/
    React.createElement(HK_Row, { label: "Setup prompt", hint: "Paste this into any LLM/agent (ChatGPT, Gemini, a custom bot) so it wires itself into Lore \u2014 no native install needed." }, /*#__PURE__*/
    React.createElement(HK_Button, { variant: "secondary", size: "sm", icon: promptCopied ? 'check' : 'copy', onClick: copyPrompt },
    ...
    React.createElement("div", { style: { margin: '0 16px 14px', background: 'var(--surface-inset)', border: '1px solid var(--border)', borderRadius: 'var(--radius-sm)', overflow: 'hidden' } }, /*#__PURE__*/
    React.createElement("pre", { style: { margin: 0, padding: '10px 14px', fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--text-muted)', lineHeight: 1.7, whiteSpace: 'pre-wrap', wordBreak: 'break-all' } }, HK_CAPTURE_SNIPPET)
    )
    )
    )
