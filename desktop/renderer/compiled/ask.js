...
function AskPanel({ messages, asking, suggestions, onSend, onClose, source, onSource, sourceOptions, identityReady, onSetup,
  ...
  return (/*#__PURE__*/
    ...
    React.createElement(AkIcon, { name: "file-text", size: 11, style: { flexShrink: 0 } }), /*#__PURE__*/
    React.createElement("span", { style: { maxWidth: 130, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, "About: ", ctx.title),
    onClearCtx && /*#__PURE__*/
