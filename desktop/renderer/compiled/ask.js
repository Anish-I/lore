...
function AkMarkdown({ text }) {
  ...
  return /*#__PURE__*/React.createElement("div", { className: "ak-md", dangerouslySetInnerHTML: { __html: akMd.render(String(text || '')) } });
}
...
function Evidence({ rows }) {
  ...
  return (/*#__PURE__*/
    ...
    open && /*#__PURE__*/React.createElement("div", { style: { padding: '2px 4px 6px' } }, rows.map((r) => /*#__PURE__*/React.createElement(EvidenceRow, _extends({ key: r.index }, r, { onOpen: () => {} }))))
    ));
...
function AskPanel({ messages, asking, suggestions, onSend, onClose, source, onSource, sourceOptions, identityReady, onSetup,
  ...
  return (/*#__PURE__*/
    ...
    React.createElement(AkMarkdown, { text: m.text || (m.shown || m.runs || []).map((r) => r.x).join('') })
    ),
