...
function AskPanel({ messages, asking, suggestions, onSend, onClose, source, onSource, sourceOptions, identityReady, onSetup }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", { style: akS.header }, /*#__PURE__*/
    ...
    React.createElement(SourceToggle, { value: source || 'all', onChange: onSource || (() => {}), options: sourceOptions }), /*#__PURE__*/
    ...
    React.createElement("p", { style: { fontSize: 13, color: 'var(--text-subtle)', margin: '0 0 16px', lineHeight: 1.5, textAlign: 'center' } }, "Answers are drawn only from notes in your scope, and every claim is cited."),
    ...
    React.createElement("span", { style: { flex: 1, fontSize: 12.5, color: 'var(--text-body)', lineHeight: 1.45 } }, "Set a tenant and scope before asking Lore."), /*#__PURE__*/
    ...
    React.createElement("button", { onClick: () => setCog((c) => !c), title: "Model, scope & citations", style: { display: 'inline-flex', alignItems: 'center', gap: 5, height: 24, padding: '0 9px', border: '1px solid var(--border)', borderRadius: 'var(--radius-full)', background: cog ? 'var(--surface-raised)' : 'transparent', color: 'var(--text-muted)', cursor: 'pointer', fontFamily: 'var(--font-mono)', fontSize: 10.5 } }, /*#__PURE__*/
    ...
    React.createElement("label", { style: { fontFamily: 'var(--font-mono)', fontSize: 10.5, color: 'var(--text-muted)' } }, "Scope", /*#__PURE__*/
