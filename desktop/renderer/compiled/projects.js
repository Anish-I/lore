...
function TeamsView({ config, onConfig, buckets, onOpenWizard, pendingInvites, inviteBusy, onAcceptInvite, onRefreshInvites, onRequestSignIn }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("p", { style: { margin: 0, fontSize: 13, lineHeight: 1.55, color: 'var(--text-subtle)', maxWidth: 380 } }, "Teams share Wizards \u2014 knowledge bases your whole team can browse and ask across. Sign in to get started."),
