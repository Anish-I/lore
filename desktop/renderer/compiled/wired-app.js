...
function App() {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement(Editor, { bucket: activeBucket, tabs: tabs, activeId: activeId, onTab: onTab, onCloseTab: closeTab, onCloseOthers: closeOtherTabs, onOpen: () => setAskOpen(true) }) :
    editorNote ? /*#__PURE__*/
    React.createElement("div", { style: { position: 'relative', flex: 1, minWidth: 0, display: 'flex' } }, /*#__PURE__*/
    React.createElement(Editor, { note: editorNote, tabs: tabs, activeId: activeId, onTab: onTab, onCloseTab: closeTab, onCloseOthers: closeOtherTabs, mode: mode, onMode: onMode, onOpen: () => {}, scope: scope, onScope: setScope, scopeOptions: scopeOptions }),
    ...
    !askOpen && editorNote && /*#__PURE__*/React.createElement(PaneResizer, { side: "context" }),
    askOpen ? askPanel : editorNote && /*#__PURE__*/React.createElement(ContextPane, { note: editorNote, connections: connections, onOpenNote: openNoteFromBacklink, cameFromId: cameFromId, onAsk: () => setAskOpen(true) })
    ),
