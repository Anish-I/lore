...
function TodoWizardDrawer({ writeScope, readScopes, onClose }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", { style: { fontSize: 11, color: 'var(--text-faint)', marginTop: 1 } }, "Paste a thread, import a mail / Slack export, or connect Gmail \u2014 get action items you can confirm.")
    ), /*#__PURE__*/
    ...
    React.createElement(WzButton, { icon: "mail", onClick: () => syncFolder('gmail'), disabled: !!syncing,
