...
function GraphView({ graph, onOpen, bases, kbFilter, onToggleBase, baseOf }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("canvas", { ref: canvasRef, style: { position: 'absolute', inset: 0, touchAction: 'none', cursor: 'grab' } }), /*#__PURE__*/
    ...
    React.createElement("p", { style: { fontSize: 12.5, color: 'var(--text-subtle)', margin: '3px 0 0' } }, dataRef.current.nodes.length, " notes \xB7 ", dataRef.current.links.length, " links \xB7 scroll to zoom \xB7 drag to pan")
    ), /*#__PURE__*/
    ...
    React.createElement("div", { title: "Scrub the graph by note creation date (version control) \u2014 drag to see knowledge as of any date", style: { display: 'inline-flex', alignItems: 'center', gap: 7, padding: '4px 11px', border: '1px solid var(--border)', borderRadius: 'var(--radius-full)', background: 'var(--surface-raised)' } }, /*#__PURE__*/
    ...
    React.createElement("input", { type: "range", min: dateBounds.lo, max: dateBounds.hi, value: Math.min(cutoff, dateBounds.hi), step: 86400000,
      ...
      style: { width: 118, accentColor: 'var(--brand-fg)', cursor: 'pointer' } }), /*#__PURE__*/
    React.createElement("span", { style: { fontFamily: 'var(--font-mono)', fontSize: 10.5, color: cutoff >= dateBounds.hi ? 'var(--text-faint)' : 'var(--brand-fg)', minWidth: 66 } }, cutoff >= dateBounds.hi ? 'all' : new Date(cutoff).toISOString().slice(0, 10))
    ), /*#__PURE__*/
    ...
    selNode && /*#__PURE__*/
    React.createElement("div", { style: { position: 'absolute', right: 18, bottom: 18, width: 240, padding: 14, background: 'var(--surface-overlay)', border: '1px solid var(--border-strong)', borderRadius: 'var(--radius-md)', boxShadow: 'var(--shadow-lg)', zIndex: 3 } }, /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 } }, /*#__PURE__*/
    React.createElement(GrIcon, { name: "file-text", size: 15, style: { color: 'var(--brand-fg)' } }), /*#__PURE__*/
    React.createElement("span", { style: { flex: 1, fontSize: 14, fontWeight: 600, color: 'var(--text-strong)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, selNode.label), /*#__PURE__*/
    React.createElement(GrScope, { scope: selNode.scope, size: "sm", showLabel: false })
    ), /*#__PURE__*/
    ...
    React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 3 } }, /*#__PURE__*/React.createElement(GrIcon, { name: "link-2", size: 11 }), selNode.links, " links"), /*#__PURE__*/
    React.createElement("span", null, selNode.updated)
    ), /*#__PURE__*/
    React.createElement(GrButton, { variant: "secondary", size: "sm", icon: "arrow-up-right", fullWidth: true, onClick: () => onOpen && onOpen(selNode.id) }, "Open note")
    )
