...
function MapOverlay({ graph, onOpen, onClose, bases, kbFilter, onToggleBase, baseOf, loading, total = 0, onShowAll }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("button", { onClick: onShowAll, title: "A place or section filter is hiding part of the map", style: {
    ...
    React.createElement(GrIcon, { name: "layers", size: 11 }), "Showing ",
    ...
    !loading && hiddenByFilters && onShowAll && /*#__PURE__*/
    React.createElement("button", { onClick: onShowAll, style: {
        display: 'inline-flex', alignItems: 'center', gap: 6, height: 30, padding: '0 14px', borderRadius: 8, marginTop: 4,
        border: '1px solid var(--border)', background: 'var(--surface-raised)', cursor: 'pointer',
        color: 'var(--text-primary)', fontFamily: 'var(--font-sans)', fontSize: 12.5
      } }, /*#__PURE__*/
    React.createElement(GrIcon, { name: "layers", size: 12 }), "Show everything"
    )
