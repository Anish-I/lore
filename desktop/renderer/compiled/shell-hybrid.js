...
function SectionRail({ sections, allCount, active, onSelect, place, theme, view, onPages, onWizards, onPeople, wizardCount, onMoveSection, sectionMoveBusy, selected, onToggleSelect, onChatSelection }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement(SidebarTab, { icon: "files", label: "Pages", active: !onWizardsView && !onPeopleView, onClick: onPages }), /*#__PURE__*/
    ...
    onPeople && /*#__PURE__*/React.createElement(SidebarTab, { icon: "users", label: "People", active: onPeopleView, onClick: onPeople })
    ),
    !onWizardsView && !onPeopleView && /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', gap: 5, alignItems: 'center', margin: '0 2px 8px' } }, /*#__PURE__*/
    React.createElement("div", { style: { flex: 1, display: 'flex', alignItems: 'center', gap: 6, padding: '5px 8px', border: '1px solid var(--border)', borderRadius: 'var(--radius-sm)', background: 'var(--surface-base)' } }, /*#__PURE__*/
    React.createElement(Sh2Icon, { name: "search", size: 12, style: { color: 'var(--text-faint)', flexShrink: 0 } }), /*#__PURE__*/
    React.createElement("input", { value: query, onChange: (e) => setQuery(e.target.value), placeholder: "Search sections\u2026",
    ...
    query && /*#__PURE__*/
    React.createElement("span", { onClick: () => setQuery(''), style: { display: 'inline-flex', cursor: 'pointer', color: 'var(--text-faint)' } }, /*#__PURE__*/
    React.createElement(Sh2Icon, { name: "x", size: 11 })
    )

    ), /*#__PURE__*/
    React.createElement("button", { onClick: () => setSelectMode((m) => !m),
    ...
    React.createElement(Sh2Icon, { name: selectMode ? 'check' : 'list-checks', size: 13 })
    )
    ), /*#__PURE__*/
    ...
    onPeopleView ? /*#__PURE__*/
    React.createElement("div", { style: { padding: '4px 8px', fontSize: 11.5, color: 'var(--text-faint)', lineHeight: 1.5 } }, "Names and interactions found across your notes and captures."
    ...
    query && !shownSections.length && /*#__PURE__*/
    React.createElement("div", { style: { padding: '6px 10px', fontSize: 11.5, color: 'var(--text-faint)' } }, "No section matches \u201C", query, "\u201D.")

    )

    ),
    selectMode && !onWizardsView && !onPeopleView && /*#__PURE__*/
    React.createElement("div", { style: { padding: '8px 2px 2px', display: 'flex', flexDirection: 'column', gap: 6 } }, /*#__PURE__*/
    React.createElement("button", { onClick: () => {if (sel.length && onChatSelection) {onChatSelection();setSelectMode(false);}},
      disabled: !sel.length,
      style: {
    ...
    React.createElement(Sh2Icon, { name: "sparkles", size: 13 }), "Chat with ",
    sel.length || 'selected', " section", sel.length === 1 ? '' : 's'
    ), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: 10.5, color: 'var(--text-faint)', lineHeight: 1.45, padding: '0 4px' } }, "Answers will draw only from the selected sections."
